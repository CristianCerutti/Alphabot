...
Within our project we also used programs such as putty ![alt text](https://github.com/Aledutto23/Alphabot/tree/main/images/putty.png?raw=true) and WinSCP to transfer the file server to the alphabot
